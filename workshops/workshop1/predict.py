...
Usage:
    python predict.py --bill_length 48.5 --bill_depth 15.0 --flipper_length 215 --body_mass 5000
"""
...
def load_model(model_path):
    if not os.path.exists(model_path):
        print(f"[Error] Model artifact '{model_path}' not found. Please run 'python train.py' first!")
        sys.exit(1)
